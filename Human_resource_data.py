...
## streamlit parts
st.set_page_config(page_title='Industrial Human Resource Data | Mohammed Faizal N', page_icon='chart_with_upwards_trend',layout='wide',)

# SETTING-UP BACKGROUND IMAGE
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background:url("https://wallpapers.com/images/high/dull-super-light-green-desktop-sg97fcp36acn0ta3.webp");
...
df1 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_ODISHA-2011.csv",encoding='ISO-8859-1')
df2 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_ASSAM-2011.csv",encoding='ISO-8859-1')
df3 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_NAGALAND-2011.csv",encoding='ISO-8859-1')
df4 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_SIKKIM-2011.csv",encoding='ISO-8859-1')
df5 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_BIHAR-2011.csv",encoding='ISO-8859-1')
df6 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_UTTAR_PRADESH-2011.csv",encoding='ISO-8859-1')
df7 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_UTTARAKHAND-2011.csv",encoding='ISO-8859-1')
df8 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_HIMACHAL_PRADESH-2011.csv",encoding='ISO-8859-1')
df9 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_PUDUCHERRY-2011.csv",encoding='ISO-8859-1')
df10 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_TAMIL_NADU-2011.csv",encoding='ISO-8859-1')
df11 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_KERALA-2011.csv",encoding='ISO-8859-1')
df12 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_GOA-2011.csv",encoding='ISO-8859-1')
df13 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_KARNATAKA-2011.csv",encoding='ISO-8859-1')
df14 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_MAHARASHTRA-2011.csv",encoding='ISO-8859-1')
df15 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_GUJARAT-2011.csv",encoding='ISO-8859-1')
df16 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_JHARKHAND-2011.csv",encoding='ISO-8859-1')
df17 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_TRIPURA-2011.csv",encoding='ISO-8859-1')
df18 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_NCT_OF_DELHI-2011.csv",encoding='ISO-8859-1')
df19 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_MIZORAM-2011.csv",encoding='ISO-8859-1')
df20 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_MANIPUR-2011.csv",encoding='ISO-8859-1')
df21 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_ARUNACHAL_PRADESH-2011.csv",encoding='ISO-8859-1')
df22 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_RAJASTHAN-2011.csv",encoding='ISO-8859-1')
df23 = pd.read_csv("D:/New folder/New folder/CSV FILES/FINAL_STATE_WEST_BENGAL-2011.csv",encoding='ISO-8859-1')

# Concatenate the dataframes
# List of dataframes
all_data = [df1, df2, df3, df4, df5, df6, df7, df8, df9, df10, df11, df12, df13, df14, df15, df16, df17, df18, df19, df20, df21, df22, df23]
...
# Display the result in Streamlit
    st.subheader("Null Values in Each Columns")
...
# In your Streamlit app
    ...
    median_values
    st.title("Median of Each Columns")
    fig, ax = plt.subplots()
